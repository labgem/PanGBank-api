...
def test_get_pangenomes_with_collection_release_filter(
    ...
    filter_params = FilterCollectionTaxonGenome(collection_release_id=1)
    result = get_pangenomes(
...
def test_get_pangenomes_with_combined_filters(session: Session, mock_data: None):
    ...
    filter_params = FilterCollectionTaxonGenome(
        collection_release_id=1, genome_name="GenomeA"
    )
...
def test_get_pangenomes_no_results(session: Session):
    ...
    filter_params = FilterCollectionTaxonGenome(collection_release_id=999)
