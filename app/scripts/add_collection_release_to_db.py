...
def main(collection_dir: Path):
    ...
    with Session(engine) as session:
        ...
        taxonomy_source = create_taxonomy_source(
            taxonomy_source_info_file, session=session
        )
        ...
        genome_sources = create_genome_sources(
            genome_sources_info_file, session=session
        )
